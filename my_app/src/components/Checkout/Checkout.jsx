...
const Checkout = () => {
  ...
  return (
    <div className="flex">
      <div className=" p-4 w-6/12">
        <form className="m-4 p-4 bg-white rounded shadow-xl w-10/12">
            <p className="text-slate-800 font-bold text-2xl">Formulario de Pago</p>
            <p className="text-slate-800 font-bold text-2xl">Compra nro: {compraId}</p>
          <div className="">
          ...
          <div className="inline-block mt-2 -mx-1 pl-1 w-1/2">
            <label className="hidden block text-sm text-slate-600" for="codigoPostal">
              Código Postal
            </label>
            <input
              className="w-full px-2 py-2 text-slate-700 bg-slate-200 rounded-lg"
          ...
          <div className="mt-4 flex justify-between">
            <p className="text-slate-700 font-medium flex items-center">Total a pagar:
           ...
           <button
              ...
              type="submit" onClick={setCartEmpty}>
              Pagar
            </button>
           </Link>
    ...
    <div className="flow-root w-5/12 p-4 ">
        <h1 className={theme ? " p-4 m-4 text-zinc-50 font-bold text-2xl":" p-4 m-4  text-slate-500 font-bold text-2xl mt-5"}>Productos Agregados</h1>
        {cart.products.length !== undefined &&
                      cart.products.length !== 0 ?<ul role="list" className="-my-6 divide-y divide-slate-200 shadow-lg p-5">
                    ...
                    </ul>:<p className="ml-10 text-slate-500">Aun no has agregado productos</p>}
